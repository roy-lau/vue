  ...
  <div id="detail">
    ...
    <div class="restaurant-card">
      ...
      <div class="product-list listitem">
        <ul class="cart-item" v-for="orderDetail in orderDetailList" :key="orderDetail">
  ...
  export default {
    ...
    methods: {
      ...
      pay: function (orderId) {
        location.href = process.dev.wechatPayUrl +
          '?openid=' + getCookie('openid') +
          '&orderId=' + orderId +
          '&returnUrl=' + encodeURIComponent(process.dev.sellUrl + '/#/order/' + orderId);
      }
    }
  }
